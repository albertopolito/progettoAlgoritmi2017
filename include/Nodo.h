...
//struttura "prototipo" che serve per ricercare un adato elemento del vettore in un singolo campo tramite la find_if dell'iteratore
    struct find_adiacenza
        {
            ...
            {
                return (ricerca_tipologia&&f_adiacenza.tipologia_arco==f_tipologia)||(ricerca_peso_arco&&f_adiacenza.peso_arco==f_peso_arco);
            }
        };
